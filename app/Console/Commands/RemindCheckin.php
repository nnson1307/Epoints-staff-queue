...
class RemindCheckin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'shift:remindCheckin';
     ...
     * @var string
     */
    protected $description = 'Nhắc nhở nhân viên check in, check out';



    public function handle(ConfigNotiRepositoryInterface $rConfigNoti)
    {
