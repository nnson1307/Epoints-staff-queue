...
class SurveyNotifi extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'epoint:survey_apply_user';
     ...
     * @var string
     */
    protected $description = 'Gửi thông báo khảo sát đến nhân viên hoặc khách hàng';
        ...
        if (count($arrBrand) > 0) {
            foreach ($arrBrand as $v) {
                ...
                try {
                    ...
                    if ($switchDb == true) {
                        // xử lý gửi thông báo 
                        $rSurvey->handleNotifiApply($v['tenant_id']);
                    }
                } catch (\Exception $e) {
                    continue;
                }
