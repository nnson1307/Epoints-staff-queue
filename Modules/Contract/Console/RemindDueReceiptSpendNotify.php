...
class RemindDueReceiptSpendNotify extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'epoint:due-receipt-spend';
     ...
     * @var string
     */
    protected $description = 'Job quét nhắc nhở đến hạn thu - chi';
     ...
     *
     * @param DueReceiptSpendRepoInterface $dueReceiptSpend
     */
    public function handle(DueReceiptSpendRepoInterface $dueReceiptSpend)
    {
        Log::info('Start - Chạy job insert log đến hạn thu-chi');
