                                        ...
                                        <tr>
                                            <td align="center" style="background-color:white;padding-top:25px;padding-bottom:0">
                                                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h4 style="margin-left: 100px; font-weight: unset"> ... xin thông báo với {{$operate_name}} là ticket {{$ticket_code}} đã quá hạn xử lý. Hãy truy cập vào để xem thông tin chi tiết nhé!</h4>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" style="background-color:white;padding-top:0;padding-bottom:20px">
                                                            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                ...
                                                                @foreach($processor_name as $key => $item)
                                                                    @if($key == 0)
                                                                        <tr>
                                                                            <td>
                                                                                <h4 style="margin-left: 70px;">Nhân viên xử lý</h4>
                                                                            </td>
                                                                            <td>
                                                                                <h4 style="margin-left: 70px;">{{$item['staff_name']}}</h4>
                                                                            </td>
                                                                        </tr>
                                                                    @else
                                                                        <tr>
